...
import { agencyData, agentData, properties } from '../../component/data/data'
              ...
              <div className="p-6 rounded-md bg-primary/10 dark:bg-primary/20">
                  <div className="md:flex items-center">
                      ...
                      <div className="md:ms-4 md:mt-0 mt-4 md:flex justify-between items-end">
                          <div>
                              <h5 className="text-2xl font-medium">{data?.name ? data?.name : 'Avenue Realty '}<span className="text-base md:inline block md:mt-0 mt-2"><span className="text-slate-400"><span className="ri-circle-fill text-[12px] md:inline-block hidden"></span>Real Estate Agency</span></span></h5>
                              ...
                              <ul className="list-none mt-2 md:flex items-center md:divide-x divide-slate-400">
                                  <li className="md:inline-flex flex">
                                      <ul className="text-amber-400 list-none">
                                          ...
                                          <li className="inline"><i className="ri-star-s-fill align-middle"></i></li>
                                          <li className="inline"><i className="ri-star-s-fill align-middle"></i></li>
                                          <li className="inline text-slate-900 dark:text-white">4.84(30)</li>
                                      </ul>
                                  </li>
