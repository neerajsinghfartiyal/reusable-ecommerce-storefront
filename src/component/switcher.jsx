        ...
        <>
            ...
            <div className="fixed top-1/4 -left-2 z-3">
                <span className="relative inline-block rotate-90">
                    ...
                    <label className="label bg-slate-900 dark:bg-white shadow-sm shadow-gray-200 dark:shadow-gray-700 cursor-pointer rounded-full flex justify-between items-center p-2 w-14 h-8" htmlFor="chk">
