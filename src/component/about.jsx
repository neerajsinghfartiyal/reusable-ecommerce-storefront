                    ...
                    <div className="md:col-span-5">
                        <div className="relative">
                            ...
                            <div className="absolute bottom-2/4 translate-y-2/4 inset-s-0 inset-e-0 text-center">
                                <Link to="#" onClick={()=>setOpen(!isOpen)} className="lightbox size-20 rounded-full shadow-md dark:shadow-gyay-700 inline-flex items-center justify-center bg-white dark:bg-slate-900 text-primary">
